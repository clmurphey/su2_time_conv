...
parser.add_option("-d", "--tDisc", dest="tDisc", default="EULER_IMPLICIT",
                  help="time discretization", metavar="TIME_DISCRE_FLOW")
...
vars = ["TIME_MARCHING", "TIME_DISCRE_FLOW"]
new_values = [options.tMarch, options.tDisc]
